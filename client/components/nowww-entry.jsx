...
export default class NowwwEntry extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      user: null
      ...
      <div className="input-group input-group-sm mb-3">
        <div className="input-group-prepend">
          <div className="dropdown">
            ...
            <button className="btn dropdown-toggle btn-outline-dark" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
            </button>
        ...
        <input type="text" className="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder='Add a Nowww'></input>
      </div>
    );
  }
}
